% /*********************************************
% 	GIST Source Separation + Enhancement Engine (NMF, NTF) (v3.9)
...
%               - [20160319](v3.8)): Added Adaptive beta(noise floor) decision rule using the power ratios between speech and noise activation [IS16 submitted!]
%               - [20160324](v3.9)): Revised noise update rule by sparsity values (advised by H.K.Kim)
% ***********************************************/
...
initial_setting_Proposed_IS_20160902;
initial_setting_SNMF;
% initial_setting_Proposed_IS_20160902_Jobs; %Tuned for CHiME4 test

dir_DB = 'O:\kmjeon\CHiME4\CHiME3\data\audio\16kHz';
...
target_list = { 
%                 'isolated_1ch_track_base/dt05_bus_real', 'isolated_1ch_track_base/dt05_caf_real', 'isolated_1ch_track_base/dt05_ped_real', 'isolated_1ch_track_base/dt05_str_real'  ... 
                 'isolated/tr05_bus_real', 'isolated/tr05_caf_real', 'isolated/tr05_ped_real', 'isolated/tr05_str_real' ...
%                     'isolated/tr05_caf_real', 'isolated/tr05_str_real', ...
                };
% SNR_list = {'0', '10','15','5'};
% SNR_list = {'0',};
% target_list = {'TMETRO'};
...
%         for SNR = SNR_list
%             dir_Noisy = [target{1}];
            DB_input = [dir_DB,'/',target{1}];
            DB_output = [dir_DB,'/IS16_kmjeon/',OUTname,'/',target{1}];
            mkdir(DB_output);
